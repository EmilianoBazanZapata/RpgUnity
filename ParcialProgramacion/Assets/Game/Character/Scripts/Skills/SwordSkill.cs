...
namespace Game.Character.Scripts.Skills
{
    public class SwordSkill : Skill
    {
        ...
        public void CreateSword()
        {
            ...
            newSwordScript.SetupSword(_finalDirection, _swordGravity, Player.Instance, _freezeTimeDuration, _returnSpeed);
        ...
        private void GenerateDots()
        {
            ...
            {
                dots[i] = Instantiate(_dotPrefab, Player.Instance.transform.position, Quaternion.identity, _dotsParent);
        ...
        {
            var position = (Vector2)Player.Instance.transform.position + new Vector2(
